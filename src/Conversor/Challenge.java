...
public class Challenge {
	...
	public static void main(String[] args) {
	     ...
	     JOptionPane.showMessageDialog(null, "Bienvenidos al Desafio Alura !","Alura", 2);
...
while(option != "Salir"     ) {      
 ...
 if (option == "Calcular el Tipo de Cambio Monetario") {
	...
	private static void edades() {
 	   ...
 	   String[] EdadSideral = { "Edad en Marte","Edad en Venus" ,"Edad en Saturno", "Edad en Mercurio", "Edad en Júpiter", "Edad en Urano","Edad en Neptuno","Salir"};
	...
	private static void convertir() {
		 ...
		 String[] Divisa = {"Pesos Argentinos a Dólares","Pesos Argentinos a Eúros" ,"Pesos Argentinos a Libras Esterlinas", "Pesos Argentinos a Yen Japonés", "Pesos Argentinos a Won-Sul Coreano", "Dólares a Pesos Argentinos","Eúros a Pesos Argentinos","Yen Japones  a Pesos Argentinos","Won-Sul Coreanos a Pesos Argentinos","Salir" };
...
JOptionPane.showMessageDialog(null, "Usted recibirá: $ "+ (String.format("%.2f", result6) + " Pesos"));
break;
...
JOptionPane.showMessageDialog(null, "Usted recibirá: $ "+ (String.format("%.2f", result7) + " Pesos"));
break;
...
JOptionPane.showMessageDialog(null, "Usted recibirá: $ "+ (String.format("%.2f", result8) + " Pesos"));
break;
...
JOptionPane.showMessageDialog(null, "Usted recibirá: $ "+ (String.format("%.2f", result9) + " Pesos"));
break;
...
JOptionPane.showMessageDialog(null, "Usted recibirá: $ "+ (String.format("%.2f", result10) + " Pesos"));
break;
